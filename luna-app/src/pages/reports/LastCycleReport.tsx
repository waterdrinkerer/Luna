...
export const LastCycleReport = () => {
  ...
  const { predictions: mlPredictions, loading, error } = useMLPredictions();
  ...
  const getNextPeriodDays = () => {
    ...
    if (mlPredictions?.nextPeriod?.days !== undefined) {
      return mlPredictions.nextPeriod.days;
    }
  ...
  return (
    <div className="min-h-screen bg-[#F6F4FF] px-5 py-6">
      ...
      <div className="flex items-center gap-2 mb-4">
        <h1 className="text-xl font-bold text-black">Last Cycle Report</h1>
